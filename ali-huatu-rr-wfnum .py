...
grws_data = [89.41, 96.84, 97.02, 97.29, 97.69]

# DQN (菱形标记，点划线，波动剧烈)
dqn_data = [86.42,94.88, 95.18, 95.63, 96.07]

# ETTS (实心点/小标记，实线，最后飙升)
etts_data = [88.68,95.97,96.44, 96.82, 97.40]
...
# 5. 保存与显示
plt.savefig('ali-rr-wfnum.png', dpi=300, bbox_inches='tight')
plt.show()

print("图片已成功保存为 ali-rr-wfnum.png")