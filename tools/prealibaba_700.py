...
if __name__ == "__main__":
    ...
    output_csv = "../workflows/alibaba/per_csv_700/tasks_j_37816_expanded_700.csv"
    # output_csv = "../workflows/alibaba/per_csv_700/tasks_j_94055_expanded_700.csv"
    # output_csv = "../workflows/alibaba/per_csv_700/tasks_j_143178_expanded_700.csv"
    # output_csv = "../workflows/alibaba/per_csv_700/tasks_j_209787_expanded_700.csv"
    # output_csv = "../workflows/alibaba/per_csv_700/tasks_j_335814_expanded_700.csv"
    # output_csv = "../workflows/alibaba/per_csv_700/tasks_j_457821_expanded_700.csv"
    # output_csv = "../workflows/alibaba/per_csv_700/tasks_j_567184_expanded_700.csv"
    # output_csv = "../workflows/alibaba/per_csv_700/tasks_j_727303_expanded_700.csv"
    ...
    if os.path.exists(input_csv):
        multiply_workflow_safe_naming(input_csv, output_csv, target_count=700)
    else:
