...
# 定义每个组中三种方法的数据
# 我根据您图片中的大致高度估算了这些值
uaws_data = [68, 65,67 , 67, 68]
ppo_data = [50, 32, 34, 38, 48]
a3c_data = [61, 58, 54, 55, 57]
...
# 5. 显示图表
# plt.show()
plt.savefig('kexue-shuliang-pinlv.png', dpi=300, bbox_inches='tight')

# 可选：打印一条消息确认保存成功
print("图片已成功保存为 kexue-shuliang-pinlv.png")