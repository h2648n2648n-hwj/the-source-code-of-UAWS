...
# 定义每个组中三种方法的数据
#科学工作流
uaws_data = [90, 78, 68, 64, 53.2]
ppo_data = [75, 44, 61, 63, 50.2]
a3c_data = [80, 56, 50, 30, 15]
#阿里数据
uaws_data = [90, 78, 68, 64, 53.2]
ppo_data = [75, 44, 61, 63, 50.2]
a3c_data = [80, 56, 50, 30, 15]
...
# 5. 显示图表
# plt.show()
plt.savefig('kexue-shuliang-wfnum.png', dpi=300, bbox_inches='tight')

# 可选：打印一条消息确认保存成功
print("图片已成功保存为 kexue-shuliang-wfnum.png")