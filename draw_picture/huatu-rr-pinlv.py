...
# 定义每个组中三种方法的数据
# 我根据您图片中的大致高度估算了这些值
uaws_data = [95.22, 95.30, 95.23, 95.28, 95.22]
ppo_data = [93.66, 93.40, 93.43,93.51, 93.48]
a3c_data = [94.13, 94.79, 94.87, 94.94, 94.44]
...
# 5. 显示图表
# plt.show()
plt.savefig('kexue-resourceratio-pinlv.png', dpi=300, bbox_inches='tight')

# 可选：打印一条消息确认保存成功
print("图片已成功保存为 kexue-resourceratio-pinlv.png")