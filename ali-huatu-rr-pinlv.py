...
grws_data = [97.02, 97.62, 97.66, 97.62, 97.66]

# DQN (菱形标记，点划线，波动剧烈)
dqn_data = [94.18,96.86, 97.32, 97.33, 97.34]

# ETTS (实心点/小标记，实线，最后飙升)
etts_data = [95.44,97.24,97.30, 97.55, 97.60]
...
# 5. 保存与显示
plt.savefig('ali-rr-pinlv.png', dpi=300, bbox_inches='tight')
plt.show()

print("图片已成功保存为 ali-rr-pinlv.png")